...
public class MovieSearchDataSourceFactory extends DataSource.Factory<Integer, Movie> {
    ...
    public MovieSearchDataSourceFactory(MovieService movieService, MovieDomainMapper mapper, String query) {
    ...
    public DataSource<Integer, Movie> create() {
        MovieSearchPageKeyedDataSource source = new MovieSearchPageKeyedDataSource(movieService, mapper, query);
